...
The downstream catalog is a separate schema-version-12 `catalog.duckdb` below a
...
Versions 1 through 11 are refused without migration; move reproducible derived
